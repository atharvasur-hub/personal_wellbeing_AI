          ...
          <div className="max-w-7xl mx-auto flex flex-col gap-8">
            ...
            {activeMenu === 'profile' && (
              <div className="flex flex-col gap-10">
                ...
                <div className={`rounded-3xl p-8 border shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden ${
                  isDarkMode ? 'bg-slate-900/90 border-slate-800' : 'bg-white border-stone-100'
                }`}>
                  <div className={`absolute top-0 left-0 right-0 h-1.5 rounded-t-3xl ${
                    isDarkMode ? 'bg-gradient-to-r from-indigo-500 via-violet-500 to-teal-400' : 'bg-gradient-to-r from-teal-400 to-cyan-500'
                  }`} />
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className={`rounded-3xl p-6 border flex flex-col justify-between gap-6 transition relative shadow-md ${
                      isDarkMode 
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-xs font-mono font-bold px-3 py-1 rounded-full border ${
                      isDarkMode ? 'bg-indigo-500/10 text-indigo-300 border-indigo-500/20' : 'bg-teal-50 text-teal-700 border-teal-100'
                    }`}>
                      4 / 6 Unlocked
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {achievements.map((ach) => {
                      ...
                      return (
                        <div 
                          key={ach.id}
                          className={`rounded-3xl p-6 border flex flex-col justify-between gap-4 transition-all duration-300 relative overflow-hidden group ${
                            ach.unlocked 
                          ...
                          {ach.unlocked ? (
                            ...
                            <div className="flex flex-col gap-1 mt-1">
                              ...
                              <div className={`w-full h-1.5 rounded-full overflow-hidden border ${
                                isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-stone-200 border-stone-300/40'
                              }`}>
